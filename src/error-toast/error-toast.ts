const _errTemplate = document.createElement('template');
_errTemplate.innerHTML = `
<style>
/* W3Schools Example toast */
#snackbar {
...
<div id="snackbar"></div>
`
export class ErrorToast extends HTMLElement {
    root: ShadowRoot;
    get message() {
    ...
    constructor() {
        ...
        this.root.appendChild(_errTemplate.content.cloneNode(true));
    }
